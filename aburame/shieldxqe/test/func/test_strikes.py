...
@pytest.mark.parametrize(
    "traffic_profile, expected_percent_blocked", [
        # BP Traffic Profile, % BLOCKED
        ("SxSecurityTest_NoSSL_Malware_Solo", 100),
        ("SxSecurityTest_NoSSL_Malware_Ransomware", 100),
        ("SxSecurityTest_NoSSL_Malware_Win32", 100),
        ("SxSecurityTest_NoSSL_Malware_Retail", 100),
        ("SxSecurityTest_NoSSL_Malware_APT", 100),
        ("SxSecurityTest_NoSSL_Malware_Financial", 100),
        ("SxSecurityTest_NoSSL_Malware_All", 100),
    ]
)
def test_strikes_malware(
    sut_handle, datadir, ixia_handle,
    shieldx_constants, shieldx_logger,
    traffic_profile, expected_percent_blocked
):
